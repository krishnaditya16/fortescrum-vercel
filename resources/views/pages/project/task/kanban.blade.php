<x-app-layout>
    ...
    @push('custom-scripts')
        <script src="{{ asset('stisla/js/shepherd/task-tour.js') }}"></script>
    @endpush
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-4 col-lg-4">
                            ...
                            <div class="mb-4">
                                <h4><i class="fas fa-spinner"></i>&nbsp; Progress</h4>
                                <div class="media-progressbar">
                                    <div class="progress-text">{{$task->progress}}%</div>
                                    <div class="progress" data-height="6" style="height: 6px;" data-toggle="tooltip" title="{{ $task->progress }}%">
                                        <div class="progress-bar bg-primary" data-width="{{ $task->progress }}%" aria-valuenow="{{ $task->progress }}" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                ...
                <div class="modal-footer bg-whitesmoke">
                    ...
                    <a href="{{ route('project.task.progress', ['id' => $data->id, 'task' => $task->id]) }}" class="btn btn-icon icon-left btn-primary" type="button"><i class="fas fa-tasks"></i> Update Progress</a>
                </div>
            </div>
        </div>
    </div>
